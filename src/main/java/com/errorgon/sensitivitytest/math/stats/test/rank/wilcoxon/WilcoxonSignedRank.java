 ...
 */
package com.errorgon.sensitivitytest.math.stats.test.rank.wilcoxon;
...
import com.errorgon.sensitivitytest.math.number.Counter;
import com.errorgon.sensitivitytest.math.stats.descriptive.rank.Rank;
import com.errorgon.sensitivitytest.math.stats.distribution.univariate.NormalDistribution;
...
public class WilcoxonSignedRank extends HypothesisTest {//TODO: exact distribution, 1 sided, handle ties
    ...
    public WilcoxonSignedRank(double[] sample1, double[] sample2, double mu, boolean isExact) {
        ...
        if (isExact) {
            com.errorgon.sensitivitytest.math.stats.test.rank.wilcoxon.WilcoxonSignedRankDistribution dist =
                    new com.errorgon.sensitivitytest.math.stats.test.rank.wilcoxon.WilcoxonSignedRankDistribution(nZ);
