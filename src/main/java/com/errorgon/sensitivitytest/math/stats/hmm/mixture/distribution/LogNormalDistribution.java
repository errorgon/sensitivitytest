...
import com.errorgon.sensitivitytest.math.stats.random.univariate.LogNormalRng;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.LogNormalDistribution
...
public class LogNormalDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < lambda.length; ++i) {
            double logMu = lambda[i].logMu;
            double logSigma = lambda[i].logSigma;
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.LogNormalDistribution(logMu, logSigma);
        }
