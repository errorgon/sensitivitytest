 ...
 */
package com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.stationaryprocess.arma;

import com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.AutoCorrelationFunction;
import com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.arima.ARIMAModel;
...
public class AutoCorrelation extends AutoCorrelationFunction {
    ...
    private com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.arma.AutoCorrelation ACF;
    ...
    public AutoCorrelation(ARIMAModel model, double wnVariance, int nLags) {
        ...
        com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.arima.ARIMAModel model_m =
                new com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.arima.ARIMAModel(model);

        ACF = new com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.arma.AutoCorrelation(
                model_m,
                nLags);
    }
