...
import com.errorgon.sensitivitytest.math.stats.descriptive.moment.Kurtosis;
import com.errorgon.sensitivitytest.math.stats.descriptive.moment.Skewness;
...
public class JarqueBera extends HypothesisTest {
    ...
    public JarqueBera(double[] sample, boolean isExact) {
        ...
        if (isExact && N <= 2000) {
            dist = new com.errorgon.sensitivitytest.math.stats.test.distribution.normality.JarqueBeraDistribution(N, nSim);
        }
