 ...
 * @author Haksun Li
 */
public class LogisticProblem extends com.errorgon.sensitivitytest.math.stats.regression.linear.LMProblem {//TODO: extend it to multiple discrete values (Or, use GLM)?

    public LogisticProblem(com.errorgon.sensitivitytest.math.stats.regression.linear.LMProblem problem) {
        super(problem);
    }
