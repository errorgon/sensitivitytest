 ...
 */
package com.errorgon.sensitivitytest.math.stats.random.univariate.exp;

import com.errorgon.sensitivitytest.math.stats.random.univariate.InverseTransformSampling;
...
public class InverseTransformSamplingExpRng extends InverseTransformSampling implements RandomExpGenerator {
    ...
    public InverseTransformSamplingExpRng(double lambda, RandomLongGenerator rng) {
        super(new com.errorgon.sensitivitytest.math.stats.distribution.univariate.ExponentialDistribution(lambda), rng);
    }
