 ...
 */
package com.errorgon.sensitivitytest.math.stats.random.concurrent;

import com.errorgon.sensitivitytest.math.stats.random.concurrent.ConcurrentCachedGenerator.Generator;
import com.errorgon.sensitivitytest.math.stats.random.multivariate.RandomVectorGenerator;
...
public class ConcurrentCachedRVG implements RandomVectorGenerator {
     ...
     * @see ConcurrentCachedGenerator#ConcurrentCachedGenerator(com.errorgon.sensitivitytest.math.stats.random.concurrent.ConcurrentCachedGenerator.Generator, int)
     */
