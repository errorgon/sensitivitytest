 ...
 * @author Haksun Li
 */
public interface Realization extends com.errorgon.sensitivitytest.math.stats.timeseries.univariate.TimeSeries<Double, Realization.Entry> {

    /**
     * This is the {@code TimeSeries.Entry} for a real number -indexed univariate time series.
     */
    public static class Entry extends com.errorgon.sensitivitytest.math.stats.timeseries.univariate.TimeSeries.Entry<Double> {
