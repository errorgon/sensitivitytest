...
import com.errorgon.sensitivitytest.math.stats.dlm.multivariate.DLMSim.Innovation;
 ...
 */
public class DLMSeries implements com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries<Integer, Innovation, DLMSeries.Entry> {

    /**
     * This is the {@code TimeSeries.Entry} for a multivariate DLM time series.
     */
    public static class Entry implements com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries.Entry<Integer, Innovation> {
