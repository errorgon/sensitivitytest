 ...
 */
package com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.stationaryprocess;

import com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.AutoCovarianceFunction;
...
import com.errorgon.sensitivitytest.math.stats.timeseries.multivariate.realtime.MultiVariateTimeSeries;
import com.errorgon.sensitivitytest.math.stats.timeseries.multivariate.realtime.SimpleMultiVariateTimeSeries;
import com.errorgon.sensitivitytest.math.stats.timeseries.univariate.realtime.SimpleTimeSeries;
import com.errorgon.sensitivitytest.math.stats.timeseries.univariate.realtime.TimeSeries;
...
public class InnovationAlgorithm {
    ...
    private com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.InnovationAlgorithm impl;
    ...
    public InnovationAlgorithm(TimeSeries Xt, final AutoCovarianceFunction K) {
        com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.AutoCovarianceFunction multiK =
                new com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.AutoCovarianceFunction() {
        ...
        impl = new com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.InnovationAlgorithm(new SimpleMultiVariateTimeSeries(Xt),
                multiK);
    }
