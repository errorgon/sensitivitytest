 ...
 */
package com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.brownian;
...
import com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.integration.sde.RandomWalk.Realization;
...
public class RandomWalk extends Brownian implements Construction {
    ...
    com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.integration.sde.RandomWalk rw;
    ...
    public RandomWalk(TimeGrid timePoints) {
        this.rw = new com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.integration.sde.RandomWalk(this, timePoints);
    }
