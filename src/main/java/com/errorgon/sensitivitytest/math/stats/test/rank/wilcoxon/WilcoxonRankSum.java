...
import static com.errorgon.sensitivitytest.math.number.DoubleUtils.concat;
...
public class WilcoxonRankSum extends HypothesisTest {
    ...
    public WilcoxonRankSum(double[] sample1, double[] sample2, double mu, boolean isExact, boolean isCorrected) {
        ...
        if (isExact) {
            com.errorgon.sensitivitytest.math.stats.test.rank.wilcoxon.WilcoxonRankSumDistribution dist =
                    new com.errorgon.sensitivitytest.math.stats.test.rank.wilcoxon.WilcoxonRankSumDistribution(N1, N2);//TODO: use the ProbabilityDistribution format
