 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.NormalDistribution
...
public class NormalDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < lambda.length; ++i) {
            double mu = lambda[i].mu;
            double sigma = lambda[i].sigma;
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.NormalDistribution(mu, sigma);
        }
