...
import com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.arima.ARIMAXModel;
...
public class ARMAXModel extends ARIMAXModel {
     ...
     */
    public ARMAXModel(com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.stationaryprocess.arma.ARMAXModel model) {
        super(model);
    }
