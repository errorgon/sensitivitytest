 ...
 */
package com.errorgon.sensitivitytest.math.stats.timeseries.multivariate;
 ...
 * @author Haksun Li
 */
public interface MultiVariateTimeSeries<T extends Comparable, E extends MultiVariateTimeSeries.Entry<T>> extends com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries<T, Vector, E> {
     ...
     * @param <T> the timestamp type
     */
    public static class Entry<T> implements com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries.Entry<T, Vector> {
