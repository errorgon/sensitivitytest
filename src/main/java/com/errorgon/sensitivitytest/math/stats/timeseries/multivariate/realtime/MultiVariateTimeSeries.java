 ...
 */
public interface MultiVariateTimeSeries extends com.errorgon.sensitivitytest.math.stats.timeseries.multivariate.MultiVariateTimeSeries<Integer, MultiVariateTimeSeries.Entry> {

    /**
     * This is the {@code TimeSeries.Entry} for an integer -indexed multivariate time series.
     */
    public static class Entry extends com.errorgon.sensitivitytest.math.stats.timeseries.multivariate.MultiVariateTimeSeries.Entry<Integer> {
