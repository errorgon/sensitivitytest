...
public class AutoCovariance extends AutoCovarianceFunction {//TODO: solve the 1D Yule-Walker equations directly for performance
    ...
    private com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.arma.AutoCovariance ACVF;
    ...
    public AutoCovariance(ARIMAModel model, double wnVariance, int nLags) {
        ...
        ACVF = new com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.arma.AutoCovariance(
                model_m,
                nLags);
    }
