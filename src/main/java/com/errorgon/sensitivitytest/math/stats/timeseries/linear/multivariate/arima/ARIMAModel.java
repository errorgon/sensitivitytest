...
import com.errorgon.sensitivitytest.math.stats.timeseries.linear.multivariate.stationaryprocess.arma.ARMAModel;
...
public class ARIMAModel extends ARIMAXModel {
     ...
     */
    public ARIMAModel(com.errorgon.sensitivitytest.math.stats.timeseries.linear.univariate.arima.ARIMAModel model) {
        super(model);
    }
