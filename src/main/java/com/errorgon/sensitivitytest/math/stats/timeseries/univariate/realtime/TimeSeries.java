 ...
 */
package com.errorgon.sensitivitytest.math.stats.timeseries.univariate.realtime;
 ...
 * @author Haksun Li
 */
public interface TimeSeries extends com.errorgon.sensitivitytest.math.stats.timeseries.univariate.TimeSeries<Integer, TimeSeries.Entry> {

    /**
     * This is the {@code TimeSeries.Entry} for an integer number -indexed univariate time series.
     */
    public static class Entry extends com.errorgon.sensitivitytest.math.stats.timeseries.univariate.TimeSeries.Entry<Integer> {
