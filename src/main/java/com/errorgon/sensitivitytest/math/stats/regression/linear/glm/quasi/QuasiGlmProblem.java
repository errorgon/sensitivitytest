...
import com.errorgon.sensitivitytest.math.stats.regression.linear.glm.quasi.family.QuasiFamily;
 ...
 * @author Haksun Li
 */
public class QuasiGlmProblem extends com.errorgon.sensitivitytest.math.stats.regression.linear.glm.GLMProblem {
     ...
     * @param quasiFamily the exponential family distribution for the mean with a quasi-likelihood function
     */
    public QuasiGlmProblem(com.errorgon.sensitivitytest.math.stats.regression.linear.LMProblem problem, QuasiFamily quasiFamily) {
