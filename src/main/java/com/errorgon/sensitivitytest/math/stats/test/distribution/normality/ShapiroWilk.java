 ...
 */
package com.errorgon.sensitivitytest.math.stats.test.distribution.normality;

import com.errorgon.sensitivitytest.math.analysis.function.FunctionOps;
...
public class ShapiroWilk extends HypothesisTest {
    ...
    public ShapiroWilk(double[] sample) {
        ...
        testStatistics = W;
        pValue = oneSidedPvalue(new com.errorgon.sensitivitytest.math.stats.test.distribution.normality.ShapiroWilkDistribution(N),
                testStatistics);
    }
}
