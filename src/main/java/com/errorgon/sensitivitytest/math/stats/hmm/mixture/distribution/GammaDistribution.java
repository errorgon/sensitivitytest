...
import com.errorgon.sensitivitytest.math.stats.random.univariate.gamma.MarsagliaTsang2000;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.GammaDistribution
...
public class GammaDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < lambda.length; ++i) {
            double k = lambda[i].k;
            double theta = lambda[i].theta;
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.GammaDistribution(k, theta);
        }
