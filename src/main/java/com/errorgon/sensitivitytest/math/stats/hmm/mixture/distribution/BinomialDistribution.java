...
import com.errorgon.sensitivitytest.math.stats.random.univariate.BinomialRng;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.BinomialDistribution
...
public class BinomialDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < lambda.length; ++i) {
            int n = lambda[i].size;
            double p = lambda[i].p;
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.BinomialDistribution(n, p);
        }
