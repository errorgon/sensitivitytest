 ...
 */
package com.errorgon.sensitivitytest.math.stats.timeseries.univariate;
 ...
 * @author Haksun Li
 */
public interface TimeSeries<T extends Comparable, E extends TimeSeries.Entry<T>> extends com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries<T, Double, E> {
     ...
     * @param <T> the timestamp type
     */
    public static class Entry<T> implements com.errorgon.sensitivitytest.math.stats.timeseries.TimeSeries.Entry<T, Double> {
