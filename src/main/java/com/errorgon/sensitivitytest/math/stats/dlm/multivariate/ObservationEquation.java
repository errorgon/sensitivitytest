 ...
 */
package com.errorgon.sensitivitytest.math.stats.dlm.multivariate;

import com.errorgon.sensitivitytest.math.analysis.function.matrix.R1toConstantMatrix;
import com.errorgon.sensitivitytest.math.analysis.function.matrix.R1toMatrix;
...
import com.errorgon.sensitivitytest.math.matrix.doubles.operation.SimilarMatrix;
import com.errorgon.sensitivitytest.math.matrix.doubles.operation.positivedefinite.CholeskyWang2006;
...
import com.errorgon.sensitivitytest.math.stats.random.multivariate.NormalRvg;
...
public class ObservationEquation {
     ...
     */
    public ObservationEquation(final com.errorgon.sensitivitytest.math.stats.dlm.univariate.ObservationEquation obs) {
        this(
                new R1toMatrix() {
