 ...
 */
package com.errorgon.sensitivitytest.math.stats.regression.linear.glm.quasi;
...
import com.errorgon.sensitivitytest.math.stats.regression.linear.glm.Fitting;
...
class NewtonRaphson implements Fitting {
    ...
    @Override
    public void fit(com.errorgon.sensitivitytest.math.stats.regression.linear.glm.GLMProblem problem, Vector beta0Initial) {
