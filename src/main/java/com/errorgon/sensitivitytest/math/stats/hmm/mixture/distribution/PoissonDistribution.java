...
import com.errorgon.sensitivitytest.math.stats.random.univariate.poisson.Knuth1969;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.PoissonDistribution
...
public class PoissonDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < rates.length; ++i) {
            double rate = rates[i];
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.PoissonDistribution(rate);
        }
