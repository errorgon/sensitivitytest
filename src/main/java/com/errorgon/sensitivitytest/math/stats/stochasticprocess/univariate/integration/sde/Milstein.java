...
import com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.sde.SDE;
...
public class Milstein extends RandomWalk {
    ...
    public Milstein(SDE sde, TimeGrid timePoints) {
        super(new com.errorgon.sensitivitytest.math.stats.stochasticprocess.univariate.sde.Milstein(sde), timePoints);
    }
