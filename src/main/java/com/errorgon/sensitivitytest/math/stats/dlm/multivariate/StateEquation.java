...
import com.errorgon.sensitivitytest.math.matrix.doubles.operation.CongruentMatrix;
...
public class StateEquation {
     ...
     */
    public StateEquation(final com.errorgon.sensitivitytest.math.stats.dlm.univariate.StateEquation states) {
        this(
                new R1toMatrix() {
