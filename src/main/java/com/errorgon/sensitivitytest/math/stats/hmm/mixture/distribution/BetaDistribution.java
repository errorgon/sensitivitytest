 ...
 */
package com.errorgon.sensitivitytest.math.stats.hmm.mixture.distribution;

import com.errorgon.sensitivitytest.math.analysis.function.matrix.RntoMatrix;
import com.errorgon.sensitivitytest.math.analysis.function.rn2r1.BivariateRealFunction;
...
import com.errorgon.sensitivitytest.math.analysis.function.rn2rm.RealVectorFunction;
import com.errorgon.sensitivitytest.math.analysis.function.special.gamma.Digamma;
import com.errorgon.sensitivitytest.math.analysis.function.special.gamma.Gamma;
import com.errorgon.sensitivitytest.math.analysis.function.special.gamma.GammaLanczosQuick;
import com.errorgon.sensitivitytest.math.analysis.function.special.gamma.Trigamma;
...
import com.errorgon.sensitivitytest.math.optimization.constrained.general.sqp.activeset.SQPActiveSetSolver;
import com.errorgon.sensitivitytest.math.optimization.constrained.problem.NonNegativityConstraintOptimProblem;
import com.errorgon.sensitivitytest.math.stats.distribution.univariate.ProbabilityDistribution;
import com.errorgon.sensitivitytest.math.stats.random.univariate.RandomNumberGenerator;
import com.errorgon.sensitivitytest.math.stats.random.univariate.beta.Cheng1978;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.BetaDistribution
...
public class BetaDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < lambda.length; ++i) {
            double alpha = lambda[i].alpha;
            double beta = lambda[i].beta;
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.BetaDistribution(alpha, beta);
        }
