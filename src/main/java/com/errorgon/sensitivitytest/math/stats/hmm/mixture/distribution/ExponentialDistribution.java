...
import com.errorgon.sensitivitytest.math.stats.random.univariate.exp.Ziggurat2000Exp;
 ...
 *
 * @author Haksun Li
 * @see com.errorgon.sensitivitytest.math.stats.distribution.univariate.ExponentialDistribution
...
public class ExponentialDistribution implements HMMDistribution {
    ...
    public ProbabilityDistribution[] getDistributions() {
        ...
        for (int i = 0; i < rates.length; ++i) {
            double rate = rates[i];
            dist[i] = new com.errorgon.sensitivitytest.math.stats.distribution.univariate.ExponentialDistribution(rate);
        }
