 ...
 */
package com.errorgon.sensitivitytest.math.stats.stochasticprocess.multivariate.brownian;
...
import com.errorgon.sensitivitytest.math.stats.stochasticprocess.timepoints.UnitGrid;
...
public class RandomWalk extends Brownian implements Construction {
    ...
    com.errorgon.sensitivitytest.math.stats.stochasticprocess.multivariate.integration.sde.RandomWalk rw;
    ...
    public RandomWalk(int d, TimeGrid timePoints) {
        super(d);
        this.rw = new com.errorgon.sensitivitytest.math.stats.stochasticprocess.multivariate.integration.sde.RandomWalk(this, timePoints);
    }
