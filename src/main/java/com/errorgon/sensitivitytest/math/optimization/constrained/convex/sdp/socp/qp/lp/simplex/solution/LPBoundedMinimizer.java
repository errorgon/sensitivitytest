 ...
 */
package com.errorgon.sensitivitytest.math.optimization.constrained.convex.sdp.socp.qp.lp.simplex.solution;
...
public class LPBoundedMinimizer implements LPSimplexMinimizer {
    ...
    public LPBoundedMinimizer(SimplexTable table) {
        ...
        SuanShuUtils.assertOrThrow(nOptimal == minimizers.size() ? null : new RuntimeException(new Error("inconsistent logic")));
    }
