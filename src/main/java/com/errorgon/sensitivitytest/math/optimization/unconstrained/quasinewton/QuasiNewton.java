 ...
 */
package com.errorgon.sensitivitytest.math.optimization.unconstrained.quasinewton;
...
import com.errorgon.sensitivitytest.math.optimization.unconstrained.linesearch.Fletcher;
import com.errorgon.sensitivitytest.math.optimization.unconstrained.steepestdescent.SteepestDescent;
...
public abstract class QuasiNewton extends SteepestDescent {
    ...
    protected abstract class QuasiNewtonImpl extends SteepestDescentImpl {
         ...
         * An implementation of {@link #updateSk(com.errorgon.sensitivitytest.math.vector.doubles.Vector)}
