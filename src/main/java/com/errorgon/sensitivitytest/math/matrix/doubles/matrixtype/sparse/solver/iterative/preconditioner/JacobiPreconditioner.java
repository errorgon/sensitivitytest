 ...
 */
package com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.preconditioner;
...
public class JacobiPreconditioner implements Preconditioner {
    ...
    public JacobiPreconditioner(Matrix A) {
        ...
        Vector D = diagonal(A);
        Dinv = com.errorgon.sensitivitytest.math.vector.doubles.dense.operation.CreateVector.foreach(
                D,
