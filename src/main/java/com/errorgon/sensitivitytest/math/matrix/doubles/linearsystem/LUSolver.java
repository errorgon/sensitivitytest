...
import com.errorgon.sensitivitytest.math.matrix.MatrixSingularityException;
...
public class LUSolver {
    ...
    public Vector solve(LSProblem problem) {
        ...
        try {
            com.errorgon.sensitivitytest.math.matrix.doubles.factorization.triangle.LU luDecomp =
                    new com.errorgon.sensitivitytest.math.matrix.doubles.factorization.triangle.LU(A,
                                                                                             0);
