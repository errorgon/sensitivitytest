 ...
 */
package com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.nonstationary;

import com.errorgon.sensitivitytest.math.algorithm.iterative.monitor.IterationMonitor;
import com.errorgon.sensitivitytest.math.algorithm.iterative.monitor.NullMonitor;
import com.errorgon.sensitivitytest.math.algorithm.iterative.tolerance.Tolerance;
import com.errorgon.sensitivitytest.math.matrix.doubles.Matrix;
import com.errorgon.sensitivitytest.math.matrix.doubles.linearsystem.BackwardSubstitution;
import com.errorgon.sensitivitytest.math.matrix.doubles.linearsystem.LSProblem;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.GivensMatrix;
...
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.ConvergenceFailure;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.ConvergenceFailure.Reason;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.IterativeLinearSystemSolver;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.preconditioner.IdentityPreconditioner;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.preconditioner.Preconditioner;
import com.errorgon.sensitivitytest.math.matrix.doubles.matrixtype.sparse.solver.iterative.preconditioner.PreconditionerFactory;
import com.errorgon.sensitivitytest.math.matrix.doubles.operation.CreateMatrix;
import com.errorgon.sensitivitytest.math.matrix.doubles.operation.SubMatrixRef;
...
import static com.errorgon.sensitivitytest.math.vector.doubles.dense.operation.CreateVector.subVector;
