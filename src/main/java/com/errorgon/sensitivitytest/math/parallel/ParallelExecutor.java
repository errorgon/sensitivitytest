 ...
 */
package com.errorgon.sensitivitytest.math.parallel;

import com.errorgon.sensitivitytest.math.parallel.SynchronizedIterator.Element;
...
public class ParallelExecutor {
    ...
    /**
     * Calls {@link #forLoop(int, int, int, com.errorgon.sensitivitytest.math.parallel.LoopBody) forLoop}
    ...
    /**
     * Calls {@link #conditionalForLoop(boolean, int, int, int, com.errorgon.sensitivitytest.math.parallel.LoopBody) conditionalForLoop}
     * with {@code increment} of 1.
     *
     * @param conditionToParallelize the condition to parallelize the for-loop execution
     * @param start                  the first loop index (inclusive)
    ...
    /**
     * Calls {@link #forEach(java.lang.Iterable, com.errorgon.sensitivitytest.math.parallel.IterationBody) forEach}
