 ...
 */
package com.errorgon.sensitivitytest.math.analysis.differentiation;

import com.errorgon.sensitivitytest.math.Constant;
import com.errorgon.sensitivitytest.math.analysis.differentiation.univariate.FiniteDifference.Type;
...
import com.errorgon.sensitivitytest.math.analysis.function.tuple.BinaryRelation;
import com.errorgon.sensitivitytest.math.analysis.interpolation.NevilleTable;
 ...
 * c.f., {@link com.errorgon.sensitivitytest.math.analysis.differentiation.univariate.FiniteDifference}.
...
public class Ridders implements RealScalarFunction {
    ...
    public Ridders(final UnivariateRealFunction f, final int order, double rate, int discretization) {
        ...
        this.dfh = new MyFunction() {
            ...
            private final com.errorgon.sensitivitytest.math.analysis.differentiation.univariate.FiniteDifference df =
                    new com.errorgon.sensitivitytest.math.analysis.differentiation.univariate.FiniteDifference(f, order, Type.CENTRAL);
    ...
    public Ridders(final RealScalarFunction f, final int[] varidx, double rate, int discretization) {
        ...
        this.dfh = new MyFunction() {
            ...
            private final com.errorgon.sensitivitytest.math.analysis.differentiation.multivariate.FiniteDifference df =
                    new com.errorgon.sensitivitytest.math.analysis.differentiation.multivariate.FiniteDifference(f, varidx);
