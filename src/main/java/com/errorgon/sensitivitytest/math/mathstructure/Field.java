 ...
 */
package com.errorgon.sensitivitytest.math.mathstructure;
...
public interface Field<F> extends Ring<F> {
     ...
     * @throws com.errorgon.sensitivitytest.math.mathstructure.Field.InverseNonExistent if the inverse does not exist
